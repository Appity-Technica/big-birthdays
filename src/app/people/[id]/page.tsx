    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="space-y-6">
        ...
        {person.pastGifts && person.pastGifts.length > 0 && (
          <div className="p-5 rounded-2xl bg-pink/5 border border-pink/20">
                ...
                <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-surface/70">
                  ...
                  {gift.url && (
                    <a
                      ...
                      className="shrink-0 p-1.5 rounded-lg hover:bg-pink/10 text-pink/60 hover:text-pink transition-colors"
                      title="View link"
                    >
      ...
      <div className="flex items-center gap-3 mt-10 pt-6 border-t border-lavender">
        ...
        <Link
          href={`/people/${person.id}/gifts`}
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border-2 border-purple/30 text-purple text-sm font-bold hover:bg-purple/5 transition-colors"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
