    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white border-2 border-lavender rounded-xl font-bold text-sm text-foreground hover:border-purple/30 hover:shadow-md transition-all mb-6"
        >
